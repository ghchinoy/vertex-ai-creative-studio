...
def main(
    ...
    top_level_key: str | None = "stable_diffusion",
    gcs_sub_folder: str | None = "stablediffusion",
    model_name: str | None = cfg.MODEL_STABLE_DIFFUSION,
    prompt_image_mapping: dict[int, str] | None = {0: "prompt", 1: "images"},
):
